...
Original file is located at
    https://colab.research.google.com/drive/10VcqVeEFHzeHdVqK-zCrV4jC2hVl-XVr
"""
...
class RMW(Experiment):
    ...
    def run_once(self, show_progress_bar = True):
        ...
        # Run trials corresponding to the day 1 to 7 (4 trials/day)
        logs = self.rat.n_trials(self.first_watermaze, 7 * 4,
                                          show_progress_bar = show_progress_bar)

        # Run trials corresponding to day 8, 9 (4 trials/day)
        logs += self.rat.n_trials(self.second_watermaze, 2 * 4,
                                          show_progress_bar = show_progress_bar)
