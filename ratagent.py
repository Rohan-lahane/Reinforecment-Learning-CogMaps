...
Original file is located at
    https://colab.research.google.com/drive/1AjOlCYgB6QI9cSRfPoKAcecbhbhaHqoC
"""
...
class Rat:
  ...
  def is_on_platform(self,watermaze):
      return norm(self.current_pos-watermaze.platform.center) <= watermaze.platform.radius
  ...
  def next_pos(self,watermaze):
    ...
    reward = 1 if self.is_on_platform(watermaze) else 0
